...
.image-tall[
![](img/half-year-results-1.png)
]

???

This repeats the LSOA plot from before but the right two columns are contemporaneous and lagged associations of collective efficacy with crime

On the Airbnb to crime left side, the results are substantively identical to the LSOA models; we see a positive contemporaneous association that doesn't go away when accounting for collective efficacy.

On the collective efficacy to crime right side, there is a very modest and only occasionally significant negative association (though again, this is stronger in yearly analyses).

Together this suggest collective efficacy is not explaining the relationship between Airbnbs and crime we're seeing
...
We already knew Airbnbs are affecting housing markets.
